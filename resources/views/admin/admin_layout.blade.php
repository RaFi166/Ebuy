	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Ebuy</span></a>
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					...
					<li><a href="{{route('home_page')}}" target="_blank"><i class="icon-envelope"></i><span class="hidden-tablet"> Visit Site</span></a></li>
						...
						<li>
							...
							<ul>
							<li><a class="submenu" href="{{route('add_category')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Category</span></a></li>
							<li><a class="submenu" href="{{route('all_category')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Category</span></a></li>
							</ul>	
						</li>
